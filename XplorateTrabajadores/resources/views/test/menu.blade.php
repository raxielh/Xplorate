...
.menu {
  ...
  @media (max-width: 500px) {
   ...
   <body onload="window.parent.parent.scrollTo(0,0)">
    <div class="container">
      <h3 style="text-align:right;color:#333;font-weight: lighter;">Hola, {{$nombre}} {{$apellido}} <a href="http://xplorate.unisinu.edu.co/XplorateTrabajadores/public/salir" class="btn btn-danger">Salir</a></h3>
      <div class="row menu1">
        <div class="col-md-6">
          <div class="menu">
              <a href="http://xplorate.unisinu.edu.co/XplorateTrabajadores/public/bienvenido" class="menu-li">
        ...
        <div class="col-md-6">
          <div class="menu">
              <a href="http://xplorate.unisinu.edu.co/XplorateTrabajadores/public/analisis" class="menu-li">
                        <div class="foto" style="width: 176px; margin: 0px auto;">
                          <img src="{{URL::asset('/img/portfolio.png')}}" class="menu-img" data-img-name="portfolio" alt="">
                        </div>
                        <div style="text-align:center;font-size:16px">Mis Resultados</div>
                    </a> 
          </div>           
        </div>
        @endif
