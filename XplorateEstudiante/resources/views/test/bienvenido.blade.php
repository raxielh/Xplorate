<html lang="es">
  ...
  <body>
    <div class="container">
      <h3 style="text-align:right;color:#333;">{{$nombre}} {{$apellido}} <a href="http://xplorate.unisinu.edu.co/XplorateEstudiante/public/inicio" class="btn btn-warning">Atras</a></h3>
      <div class="row" style="background-color: #fff;padding: 2em;border-radius: 2em">
              <div class="col-md-12">
                    ...
                    <div style="text-align: center;">
                        <a href="http://xplorate.unisinu.edu.co/XplorateEstudiante/public/test" id="btn" class="btn btn-success"><span class="glyphicon glyphicon-send" aria-hidden="true"></span>
                        <?php if($c==0){ ?>
                          Comenzar
                        <?php } else{  ?>
                          Continuar
                        ...
                        <a href="http://xplorate.unisinu.edu.co/XplorateEstudiante/public/inicio" class="btn btn-danger"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Cancelar</a>
                    </div>
              </div>
      </div>
    </div>
