...
Route::get('/recuperar', 'TestController@recuperar');
Route::get('/recuperar_correo', 'TestController@recuperar_correo');
Route::post('/recuperar_correo_action', 'TestController@recuperar_correo_action')->name('recuperar_correo');

Route::post('/recuperar', 'TestController@recuperar_action')->name('recuperar');
Route::get('/cambiar', 'TestController@cambiar');
Route::post('/pass_action', 'TestController@pass_action')->name('pass_action');
...
Route::post('/procesar_registro', 'TestController@procesar_registro')->name('registro');
...
Route::get('/historico_social', 'TestController@historico_social')->name('historico_social');
Route::get('/historico_proposito', 'TestController@historico_proposito')->name('historico_proposito');
Route::get('/historico_fisico', 'TestController@historico_fisico')->name('historico_fisico');
Route::get('/historico_financiero', 'TestController@historico_financiero')->name('historico_financiero');
Route::get('/historico_emocional', 'TestController@historico_emocional')->name('historico_emocional');
Route::get('/historico_depresion', 'TestController@historico_depresion')->name('historico_depresion');
Route::get('/historico_ansiedad', 'TestController@historico_ansiedad')->name('historico_ansiedad');
...
Route::resource('personaCategorias', 'PersonaCategoriaController');