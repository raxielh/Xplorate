...
@media (max-width: 600px) {
  ...
  <body>
    <div class="container">
      ...
      <div class="row bg">
        <div style="text-align: right;"><a class="btn btn-info" href="http://xplorate.unisinu.edu.co/XplorateTrabajadores/public/historico"><i class="glyphicon glyphicon-calendar"></i> Grafico Historico</a></div>
        <div class="col-md-12">
          ...
          <h3 style="color:#4285f4">Bienestar Social <span style="padding-left: 0.5em;padding-right: 0.5em;border-radius: 27em;background:#fff;padding-top: 0.3em;padding-bottom: 0.3em;color:#333;border: 1px solid {!!$c_social!!};">{!!$social!!}</span></h3>
          <p>{{$d_social}}</p>
          <h3 style="color:#db4437">Bienestar Fisico <span style="padding-left: 0.5em;padding-right: 0.5em;border-radius: 27em;background:#fff;padding-top: 0.3em;padding-bottom: 0.3em;color:#333;border: 1px solid {!!$c_salud!!};">{!!$salud!!}</span></h3>
          <p>{{$d_salud}}</p>
          <h3 style="color:#f4b400">Bienestar Financiero <span style="padding-left: 0.5em;padding-right: 0.5em;border-radius: 27em;background:#fff;padding-top: 0.3em;padding-bottom: 0.3em;color:#333;border: 1px solid {!!$c_financiero!!};">{!!$financiero!!}</span></h3>
          <p>{{$d_financiero}}</p>
          <h3 style="color:#0f9d58">Bienestar Emocional <span style="padding-left: 0.5em;padding-right: 0.5em;border-radius: 27em;background:#fff;padding-top: 0.3em;padding-bottom: 0.3em;color:#333;border: 1px solid {!!$c_emocional!!};">{!!$emocional!!}</span></h3>
          <p>{{$d_emocional}}</p>
          <h3 style="color:#ab47bc">Proposito <span style="padding-left: 0.5em;padding-right: 0.5em;border-radius: 27em;background:#fff;padding-top: 0.3em;padding-bottom: 0.3em;color:#333;border: 1px solid {!!$c_significado!!};">{!!$significado!!}</span></h3>
          <p>{{$d_significado}}</p>
        </div>
      </div>
    </div>
  ...
  <div class="modal fade" id="cuarto" role="dialog">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Bienestar Fisico</h4>
        </div>
        <div class="modal-body">
          <p>{!!$d_salud!!}</p>
        </div>
