<html lang="es">
    ...
    <div class="container-fluid">
      <div id="login">
          <div class="row">
            ...
            <form action="{{route('registro')}}" name="registrarse" method="post">
                 @csrf
          <div class="row">
              <div class="col-md-6">
          ...
          <div class="row">
              <div class="col-md-12 espacio-arriba" style="text-align:right">
                 <a href="/XplorateTrabajadores/public/test" class="btn btn-danger">Cancelar</a> 
  ...
  $("#cedula").keyup(function(){
      ...
      $.getJSON( "/XplorateTrabajadores/public/buscar_identificacion/"+$("#cedula").val(), function( data ) {
       ...
       $("#departamento").change(function () {
               $("#departamento option:selected").each(function () {
                i = $(this).val();
                $('#municipio').empty();
                $.getJSON('/XplorateTrabajadores/public/buscar_municipio/'+i, function(json, textStatus) {
