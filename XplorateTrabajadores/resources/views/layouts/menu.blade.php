<li class="{{ Request::is('home*') ? 'active' : '' }}">
    <a href="http://xplorate.unisinu.edu.co/XplorateTrabajadores/public/home"><i class="fa fa-home"></i><span> Inicio</span></a>
</li>
...
<li class="{{ Request::is('personaCategorias*') ? 'active' : '' }}">
    <a href="{!! route('personaCategorias.index') !!}"><i class="fa fa-edit"></i><span>Quien puede?</span></a>
</li>
...
<li>
<form name="loginform" id="loginform" action="http://xplorate.unisinu.edu.co/XplorateTrabajadores/public/web/wp-login.php" method="post">
