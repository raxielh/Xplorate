<html lang="es">
  <head>
    ...
    .bg{
      background-color: #fff;padding: 0em;border-radius: 0em;
    }
    }
    </style>
  </head>
   <body onload="window.parent.parent.scrollTo(0,0)">
    <div class="container">
      <h3 style="text-align:right;color:#333;font-weight: lighter;">{{$nombre}} {{$apellido}} <a href="http://xplorate.unisinu.edu.co/XplorateTrabajadores/public/inicio" class="btn btn-warning">Atras</a></h3>
      <div class="row bg">
              <div class="col-md-12">
                    ...
                    <div style="text-align: center;">
                        <a href="http://xplorate.unisinu.edu.co/XplorateTrabajadores/public/test" id="btn" class="btn btn-success"><span class="glyphicon glyphicon-send" aria-hidden="true"></span>
                        <?php if($c==0){ ?>
                          Comenzar
                        <?php } else{  ?>
                          Continuar
                        ...
                        <a href="http://xplorate.unisinu.edu.co/XplorateTrabajadores/public/inicio" class="btn btn-danger"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Cancelar</a>
                    </div>
              </div>
      </div>
    </div>
