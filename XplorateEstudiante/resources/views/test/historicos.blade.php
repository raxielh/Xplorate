  ...
  <body>
    <div class="container">
      <h3 style="text-align:right;color:#333;">Tu analisis {{$nombre}} {{$apellido}} 
        <a href="http://xplorate.unisinu.edu.co/XplorateEstudiante/public/analisis" class="btn btn-warning">Atras</a>
    ...
    function cargar_cambio1(cambio,dimension){
      $.getJSON('http://xplorate.unisinu.edu.co/XplorateEstudiante/public/consulta_cambio', {t_cambio:cambio,t_dimension:dimension}, function(json){
