	       ...
	       if ($r_sql_demograficos1->num_rows > 0) 
				{
				    ...
				    while($rw_sql_demograficos1 = $r_sql_demograficos1->fetch_assoc()) 
				    {
							$sql_demograficos2=" 
							 ...
							 SELECT rh1.`persona`, p.`idpregunta` idpregunta,p.`descripcion` descpregunta,pr.`idposibles_respuestas` idrespuesta,pr.`valor` descrespuesta
							 FROM  `b_respuestas_historic_1` rh1,
