  ...
  <body>
    <div class="container">
      <h3 style="text-align:right;color:#333;">Tu analisis {{$nombre}} {{$apellido}} 
        <a href="http://xplorate.unisinu.edu.co/XplorateEstudiante/public/inicio" class="btn btn-warning">Atras</a>
        <a href="http://xplorate.unisinu.edu.co/XplorateEstudiante/public/salir" class="btn btn-danger">Salir</a>
      </h3>
      <div class="row" style="background-color: #fff;padding: 2em;border-radius: 2em;padding-bottom: 5em">
        <div style="text-align: right;"><a class="btn btn-info" href="http://xplorate.unisinu.edu.co/XplorateEstudiante/public/historico"><i class="glyphicon glyphicon-calendar"></i> Grafico Historico</a></div>
        <div class="col-md-12">
