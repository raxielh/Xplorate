...
@section('content')
    ...
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
                <form action="http://xplorate.unisinu.edu.co/XplorateEstudiante/public/souvenir_b" method="post">
                            @csrf
                    <div class="row">
                        <div class="col-md-4">
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
               <form action="http://xplorate.unisinu.edu.co/XplorateEstudiante/public/entregar" method="post">
                            @csrf
