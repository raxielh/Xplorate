...
@section('content')
    <section class="content-header">
        <h1>
            ...
            <a href="http://xplorate.unisinu.edu.co/XplorateTrabajadores/public/categorias/{{$posiblesRespuestas[0]->categoria}}" class="btn btn-default">Atras</a>
            @else
                    ...
                    <div class="box-body">
                        <div class="row" style="padding-left: 20px">
                            ...
                            {!! Form::open(['route' => 'posiblesRespuestas.store']) !!}
                                ...
                                <div class="form-group col-sm-12" id="pd">
                                        {!! Form::label('preguntadependiente', 'Pregunta Dependiente:') !!}
                                        {!! Form::select('preguntadependiente',$preguntadependiente, null, ['class' => 'form-control chosen-select']) !!}
                                </div>
