...
<html lang="es">
  ...
  <body onload="window.parent.parent.scrollTo(0,0)">
    <div class="container">
      ...
      <div class="row" style="background-color: #fff;padding: 2em;border-radius: 2em;padding-bottom: 5em">
        <div class="col-md-12">
          ...
          <div class="row">
            <div class="col-md-6">
              <h4 style="color: #4285f4;" id="tt_social"></h4>
              <p style="font-size: 16px;padding: 1em;" id="t_social"></p>
            </div>
            <div class="col-md-6">
              <h4 style="color: #db4437;" id="tt_physical"></h4>
              <p style="font-size: 16px;padding: 1em;" id="t_physical"></p>              
            </div>
            <div class="col-md-6">
              <h4 style="color: #0f9d58;" id="tt_emotional"></h4>
              <p style="font-size: 16px;padding: 1em;" id="t_emotional"></p>
            </div>
            <div class="col-md-6">
              <h4 style="color: #f4b400;" id="tt_financial" ></h4>
              <p style="font-size: 16px;padding: 1em;" id="t_financial"></p>
            </div>
            <div class="col-md-6">
              <h4 style="color: #ab47bc;" id="tt_sentido_significado_proposito"></h4>
    ...
    function drawChart() {
      ...
      data.addColumn('number', 'Bienestar Social');
