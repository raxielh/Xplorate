<html lang="es">
  ...
  <body>
    <div class="container">
      <h3 style="text-align:right;color:#333;">{{$nombre}} {{$apellido}} <a href="http://xplorate.unisinu.edu.co/XplorateEstudiante/public/bienvenido" class="btn btn-warning">Atras</a></h3>
      <div class="row" style="background-color: #fff;padding: 2em;border-radius: 2em">
        <div class="col-md-12">
          ...
          <div style="text-align: center;">
            ...
            <a href="http://xplorate.unisinu.edu.co/XplorateEstudiante/public/calcular" class="btn btn-success">Ver resultado</a>
          </div>
          
          <?php } else{ ?>

          <form action="http://xplorate.unisinu.edu.co/XplorateEstudiante/public/contestar" id="frm" method="post">
            @csrf
