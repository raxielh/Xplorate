<html lang="es">
      ...
      <div id="login">
          ...
          <div class="row">
              <div class="col-md-12 espacio-arriba" style="text-align:right">
                 <a href="/XplorateEstudiante/public/test" class="btn btn-danger">Cancelar</a> 
  ...
  $("#cedula").keyup(function(){
      ...
      $.getJSON( "/XplorateEstudiante/public/buscar_identificacion/"+$("#cedula").val(), function( data ) {
       ...
       $("#departamento").change(function () {
               $("#departamento option:selected").each(function () {
                i = $(this).val();
                $('#municipio').empty();
                $.getJSON('/XplorateEstudiante/public/buscar_municipio/'+i, function(json, textStatus) {
