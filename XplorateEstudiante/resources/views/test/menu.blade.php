...
.menu {
  ...
  <body>
    <div class="container">
      <h3 style="text-align:right;color:#333;">Hola, {{$nombre}} {{$apellido}} <a href="http://xplorate.unisinu.edu.co/XplorateEstudiante/public/salir" class="btn btn-danger">Salir</a></h3>
      <div class="row menu1">
        <div class="col-md-6">
          <div class="menu">
              <a href="http://xplorate.unisinu.edu.co/XplorateEstudiante/public/bienvenido" class="menu-li">
        ...
        <div class="col-md-6">
          <div class="menu">
              <a href="http://xplorate.unisinu.edu.co/XplorateEstudiante/public/analisis" class="menu-li">
                        <div class="foto" style="width: 176px; margin: 0px auto;">
